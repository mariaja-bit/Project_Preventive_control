...
define(['N/search', 'N/file', 'N/runtime'], (search, file, runtime) => {
    ...
    function execute(context) {
        try {
            log.audit('Script Start', 'Beginning duplicate analysis');
            
            const duplicates = {
                nativeSerial: findNativeDuplicates(),
                customSerial: findCustomFieldDuplicates(CONFIG.CUSTOM_SERIAL_FIELD, 'Serial'),
                nativeLot: findLotDuplicates(),
                customLot: findCustomFieldDuplicates(CONFIG.CUSTOM_LOT_FIELD, 'Lot'),
                voidLot: findCustomFieldDuplicates(CONFIG.VOID_LOT_FIELD, 'Void Lot'),
                voidUnit: findCustomFieldDuplicates(CONFIG.VOID_UNIT_FIELD, 'Void Unit')
            };
