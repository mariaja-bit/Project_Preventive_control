                      ...
                      <div className="space-y-2">
                        {data.duplicates.map((dup, i) => (
                          <div key={i} className="flex items-center justify-between bg-red-500/20 p-3 rounded border border-red-500/50">
                            ...
                            <span className={`px-2 py-1 rounded text-xs font-bold ${dup.priority === 'CRITICAL' ? 'bg-red-500' : 'bg-orange-500'
                              }`}>
                              {dup.priority}
                            </span>
                          </div>
            ...
            {activeTab === 'cleanup' && (
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
                ...
                <div className="space-y-4">
                  ...
                  <div className={`p-4 rounded-lg border-2 ${data.duplicates.length > 0 ? 'bg-orange-500/20 border-orange-500' : 'bg-green-500/20 border-green-500'
                    }`}>
                  ...
                  logs.map((log, i) => (
                    <div key={i} className="bg-black/30 p-3 rounded text-xs">
                      <div className="flex items-center justify-between mb-1">
                        <span className={`font-semibold ${log.type === 'error' ? 'text-red-400' :
...
export default NetSuiteInventoryDemo;